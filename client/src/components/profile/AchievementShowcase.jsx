  ...
  return (
    <div>
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="text-xs font-black uppercase tracking-[0.18em] text-clutch-muted">Achievements</div>
          <h3 className="mt-2 text-2xl font-black text-clutch-text">{summary.completionPercentage || 0}% complete</h3>
        </div>
      ...
      {rarest && (
        <div className="mt-5 border-l-2 border-clutch-blue/80 pl-4">
          <div className="text-xs font-black uppercase tracking-[0.16em] text-clutch-muted">Rarest unlock</div>
          <div className="mt-1 line-clamp-1 text-base font-black text-clutch-text">{rarest.displayName || rarest.achievementName}</div>
      ...
      <div className="mt-5 divide-y divide-white/10">
        {recent.map((achievement) => (
          <div key={`${achievement.appId}-${achievement.achievementName}`} className="flex items-center gap-3 py-3">
