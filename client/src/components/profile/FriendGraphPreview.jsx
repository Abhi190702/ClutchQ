  ...
  return (
    <div className="rounded-md bg-black/15 p-4">
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="text-xs font-bold uppercase tracking-[0.16em] text-clutch-muted">Friend graph</div>
          <h3 className="mt-2 text-xl font-black text-clutch-text">{friends.length} synced friends</h3>
        </div>
      ...
      <div className="mt-4 space-y-3">
        {friends.slice(0, 5).map((friend) => (
          <div key={friend.friendSteamId || friend.displayName} className="flex items-center gap-3">
