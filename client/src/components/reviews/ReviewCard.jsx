  ...
  return (
    <div className="rounded-lg border border-clutch-border bg-clutch-panelSoft p-4">
      <div className="flex items-center justify-between gap-3">
        <div className="font-black text-clutch-text">{review.reviewerId?.name || "Teammate"}</div>
        <div className="rounded-full border border-clutch-green/40 bg-clutch-green/10 px-2 py-1 text-xs font-black text-green-200">{average}/5</div>
      </div>
