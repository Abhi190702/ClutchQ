...
const MissingRoleDetector = ({ missing = [] }) => (
  <div className="card p-5">
    <h3 className="text-lg font-black">Missing role detector</h3>
    <p className="mt-2 text-sm text-clutch-muted">ClutchQ recommends the next player based on role gaps and chemistry.</p>
